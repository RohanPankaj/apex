...
class CassieIKEnv:
    #NOTE: Changed traj from "stepping" to "walking backwards"
    def __init__(self, traj="walking backwards", simrate=60, clock_based=True, filename="spline_stepping_traj.pkl"):
